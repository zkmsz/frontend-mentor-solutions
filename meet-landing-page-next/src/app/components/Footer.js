...
const Footer = () => {
  return (
    <div>
      <footer className="relative bg-[url('/mobile/image-footer.jpg')] md:bg-[url('/tablet/image-footer.jpg')] lg:bg-[url('/desktop/image-footer.jpg')] bg-cover bg-top lg:h-[19.5rem]">
